...
// Componente principal del dashboard del cuidador
export function SitterDashboard({ user, onNavigate }) {
  // Estados para horarios y zonas de servicio
  ...
  // Agrega una nueva zona de servicio
  ...
  // Activa/desactiva una zona de servicio
  ...
  // Estados para reglas de descuento de planes
  ...
  // Estados para combos de servicios
  ...
  // Estados para servicios del sistema
  ...
  // Servicios disponibles para combos
  ...
  // Estados para creación y edición de combos y reglas
  ...
  // Estados para alta/baja/edición de servicios
  ...
  // Utilidad: retorna color de estado para servicios/combos
  ...
  // Utilidad: formatea moneda en ARS
  ...
  // Utilidad: retorna icono según nombre de servicio
  ...
  // Utilidad: retorna nombre de servicio en español
  ...
  // Utilidad: retorna nombre de rol en español
  ...
  // Filtra servicios según búsqueda, estado y rol
  ...
  // Agrega una nueva regla de descuento
  ...
  // Guarda las reglas de descuento (simulado)
  const saveDiscountRules = () => {
    toast.success('Reglas de descuento guardadas exitosamente');
  };

  // Calcula el precio original y final de un combo
  ...
  // Maneja la selección/deselección de servicios en un combo
  ...
  // Cambia el descuento de un combo y recalcula precios
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Panel de pestañas para navegar entre secciones */}
      <TabsPanel
      ...
      {/* Modal para crear regla de descuento */}
      <CreateDiscount
        open={isEditingRule}
